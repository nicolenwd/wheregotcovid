...
# Loading dataset
visit_data_raw <- fread("visit_data_raw.csv", header = T, encoding = "UTF-8") %>% select(-V1)
...
write_csv(visit_data_clean, "visit_data_clean.csv", col_names = T) 
...
write_csv(visit_data_coords, "visit_data_coords.csv", col_names = T)
